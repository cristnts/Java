...
<html>
    ...
    <div class="nav-wrapper">
      <a href="#!" class="brand-logo">Buscar empleadas</a>
            ...
            <div class="col s6">
                ...
                <div class="input-field">
                    ...
                    <label for="rut">rut</label>
                        ...
                        <c:out value="${rutEmpleada}"/><br>
                        <c:out value="${nombreEmpleada}"/><br>
                        <c:out value="${apellidoEmpleada}"/><br>
                        <c:out value="${telefonoEmpleada}"/><br>
                        <c:out value="${clasificacionEmpleada}"/>
                        ${msg}
            </div>  
        </div>
